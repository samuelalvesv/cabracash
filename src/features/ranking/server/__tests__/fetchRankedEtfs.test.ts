...
describe("fetchRankedEtfs cache behaviour", () => {
  type CacheModule = typeof import("@/features/ranking/server/cache");
  type FetchRankedEtfsModule = typeof import("@/features/ranking/server/scoring");
  ...
  beforeEach(async () => {
    ...
    cacheModule = await import("@/features/ranking/server/cache");
    cacheModule.clearAllCaches();
    ({ fetchRankedEtfs } = await import("@/features/ranking/server/scoring"));
    vi.useRealTimers();
  });
